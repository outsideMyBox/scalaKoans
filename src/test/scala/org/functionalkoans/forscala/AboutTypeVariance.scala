...
// ================================================================================================
// My notes:
// - Difference between TypeTag[T] and Manifest[T]:
//   Both to carry along type information available at compile time, to runtime. TypeTag should be 
//   considered to be a richer replacement of Manifest.
//   
// ================================================================================================
...
class AboutTypeVariance extends KoanSuite with ShouldMatchers {
  ...
  koan("""Using type inference the type that you instantiate will be the val or var reference type""") {
...
// This will allow you to set the your container to either a variable with the same type or a parent type.
