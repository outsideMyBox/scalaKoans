...
// ================================================================================================
// My notes:
// The type of z:Any* will be a WrappedArray[T] (wrap an array depending on the type of its elements).
// ================================================================================================

class AboutRepeatedParameters extends KoanSuite {

  def repeatedParameterMethod(x: Int, y: String, z: Any*) = {
    println(z.getClass) // class scala.collection.mutable.WrappedArray$ofRef
