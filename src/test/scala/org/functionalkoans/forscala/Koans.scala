...
class Koans extends Suite {
  override def nestedSuites = List(
    ...
    new AboutAbstractTypes,

    new AboutImportsAndPackages,
    new subpackage.AboutImportsAndPackagesInSubpackages,
    new media.AboutReferencingAbsolutePackages,
    new media.AboutReferencingAbsoluteRootPackages,
    new media.AboutReferencingRelativePackages,
    new AboutImportingTechniques,

    // new AboutLiterals, deprecated usages.
    new AboutManifests,
    new AboutTypeAliases,
    new AboutTypeBounds,
    new AboutTypeProjections,
